...
class ConfigurationEntryApi
{
    ...
    {
        list($response) = $this->getConfigurationEntryCollectionWithHttpInfo($key, $sub_key, $value, $application_id, $page, $pagination);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getConfigurationEntryCollectionAsync($key = null, $sub_key = null, $value = null, $application_id = null, $page = '1', $pagination = null)
    {
        return $this->getConfigurationEntryCollectionAsyncWithHttpInfo($key, $sub_key, $value, $application_id, $page, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getConfigurationEntryCollectionRequest($key = null, $sub_key = null, $value = null, $application_id = null, $page = '1', $pagination = null)
    {
     ...
     * @throws \VentureLeap\ConfigurationService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurationEntryItemWithHttpInfo($id)
    {
        $returnType = '\VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationRead';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationWrite $body The new ConfigurationEntry resource (optional)
     *
     * @throws \VentureLeap\ConfigurationService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationRead
     ...
     *
     * @param  string $id id (required)
     * @param  \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationWrite $body The updated ConfigurationEntry resource (optional)
     *
     * @throws \VentureLeap\ConfigurationService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationRead
