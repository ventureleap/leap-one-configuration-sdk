...
class ConfigurationEntryApi
{
    ...
    protected function deleteConfigurationEntryItemRequest($uuid)
    {
        ...
        $resourcePath = '/configuration/configuration_entries/{uuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationWrite $body The new ConfigurationEntry resource (required)
     *
     * @throws \VentureLeap\ConfigurationService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationRead
     ...
     *
     * @param  \VentureLeap\ConfigurationService\Model\ConfigurationEntryJsonldConfigurationWrite $body The updated ConfigurationEntry resource (required)
     * @param  string $uuid Resource identifier (required)
     *
     * @throws \VentureLeap\ConfigurationService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
